...
function AppRoutes({ userInfo, setUserInfo, openLogin }) {
  return (
    <Routes>
      ...
      <Route path="/user/*" element={<UserRoutes userInfo={userInfo} setUserInfo={setUserInfo} openLogin={openLogin} />} />
      ...
      <Route path="/notification" element={<NotificationPage userInfo={userInfo} setUserInfo={setUserInfo} openLogin={openLogin} />} />
    </Routes>
  )
}
