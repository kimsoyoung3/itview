...
export const getCollectionToAdd = (contentId, page) => axios.get(`${process.env.REACT_APP_API_URL}/api/collection/add/${contentId}?page=${page}`, {withCredentials: true});
export const addCollectionItem = (contentId, data) => axios.post(`${process.env.REACT_APP_API_URL}/api/collection/add/${contentId}`, data, {withCredentials: true});
