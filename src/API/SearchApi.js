...
export const searchContentsDetail = async (type, keyword) => axios.get(`${process.env.REACT_APP_API_URL}/api/search/content/detail?type=${type}&keyword=${keyword}`, {withCredentials: true});
