...
/////////0825 vidio 추가///////////////////////////////////////////////////////////////////////////////////////////
     ...
     * 영상 등록/수정 폼
     */
    // 📌 전체 조회 (특정 콘텐츠의 영상 목록 조회)
    @GetMapping("/content/{contentId}/videos")
    public String listVideos(@PathVariable Integer contentId, Model model) {
        List<VideoDTO> videos = contentService.getVideosByContentId(contentId);
        model.addAttribute("videos", videos);
        model.addAttribute("contentId", contentId);
        return "content/videoList"; // 별도 목록 페이지
    }
    ...
    public String submitVideo(@PathVariable Integer contentId,
        ...
        return "redirect:/content/" + contentId + "/videos"; // 👉 목록으로 이동
    }
    ...
    public String deleteVideo(@PathVariable Integer contentId,
        ...
        return "redirect:/content/" + contentId + "/videos";
    }
